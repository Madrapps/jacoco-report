...
async function action() {
    ...
    try {
        ...
        const ignoreRemovedFiles = (0, processors_1.parseBooleans)(core.getInput('ignore-removed-files')) === true;
        ...
        const changedFiles = await getChangedFiles(base, head, client, debugMode, ignoreRemovedFiles);
        if (debugMode)
...
async function getChangedFiles(base, head, client, debugMode, ignoreRemovedFiles) {
